...
if hasattr(__builtins__,'__IPYTHON__'):
    get_ipython().system('sudo -H apt-get update -qq')
    get_ipython().system('sudo -H apt-get install -qq libtinfo5')
    ...
    get_ipython().system('sudo pip install paramiko')
    get_ipython().system('sudo -H pip install --quiet --upgrade --root-user-action=ignore --no-cache-dir aimet-torch==2.14 "torch<2.9" --index-url=https://pypi.org/simple')
    get_ipython().system('sudo -H pip install --quiet --upgrade --root-user-action=ignore --no-cache-dir pydantic==2.11.3')
    get_ipython().system('sudo -H pip install --quiet --upgrade --root-user-action=ignore --no-cache-dir transformers==4.51.1')
