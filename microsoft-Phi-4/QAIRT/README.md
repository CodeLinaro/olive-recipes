...
This repository demonstrates the optimization of the [Microsoft Phi-4](https://huggingface.co/microsoft/Phi-4) model using **post-training quantization (PTQ)** techniques.
...
✅ Optimized model saved in: `models/phi4-qnn/`
