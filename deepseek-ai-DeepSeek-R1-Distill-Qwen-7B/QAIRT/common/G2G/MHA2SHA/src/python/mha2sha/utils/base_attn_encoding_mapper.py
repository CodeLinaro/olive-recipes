...
class BaseAttnNode:
    ...
    maskedsoftmax_reducemin:Union[NodeProto, List[NodeProto]]
    maskedsoftmax_add:Union[NodeProto, List[NodeProto]]
    maskedsoftmax_where:Union[NodeProto, List[NodeProto]]
...
def create_base_attn_mapping_dict(mha_base_attn_node)->Dict[str, NodeMappingDict]:
    ...
    return {
        ...
        "maskedsoftmax_reducemin": create_activation_node_mapping_dict(
            input_1_name=None,
            input_2_name=None,
            output_name=mha_base_attn_node.maskedsoftmax_reducemin.output[0] if mha_base_attn_node.maskedsoftmax_reducemin is not None else None
        ),
        "maskedsoftmax_add": create_activation_node_mapping_dict(
            input_1_name=None,
            input_2_name=None,
            output_name=mha_base_attn_node.maskedsoftmax_add.output[0] if mha_base_attn_node.maskedsoftmax_add is not None else None
        ),
        "maskedsoftmax_where": create_activation_node_mapping_dict(
            input_1_name=None,
            input_2_name=None,
            output_name=mha_base_attn_node.maskedsoftmax_where.output[0] if mha_base_attn_node.maskedsoftmax_where is not None else None
        ),
...
def update_base_attn_sha_encoding_name_to_base_attn_encoding_mapping_dict(base_attn_mapping_dict, sha_base_attn_node_list):
    ...
    base_mapping_dict_keys_node_attr_pair = [
        ...
        ("maskedsoftmax_reducemin", "maskedsoftmax_reducemin"),
        ("maskedsoftmax_add", "maskedsoftmax_add"),
        ("maskedsoftmax_where", "maskedsoftmax_where"),
    ]
