...
class GqaExtension:
    ...
    def reset_and_pre_build_kv_proj_nodes(
        ...
        # Handles LORA v1 case (partial LORA is not supported for LORA v1)
        if self.mha2sha_optim.lora_model and "mha_lora_node" in info_dict["key"] and "mha_lora_node" in info_dict["value"]:
