...
def llm_generate_position_ids_for_draft_and_forecast_tokens(n_branch_list, pos_id_for_valid_token, num_forecast_per_token, num_draft_tokens, use_top1_expand=False):
    '''
